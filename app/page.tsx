          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="prose max-w-none">
              <p className="mb-6 text-lg">
                Hello! I&apos;m {siteConfig.author.name}, a software Engineering & AI student at
                VIVES University of Applied Sciences. I build software that works, scales, and is
              ...
              <p className="mb-4">
                ...
                determine device locations using Bluetooth signal strength, similar to how
                satellites operate. Today, I work with AI and developed Pop-a-loon, a browser
                extension with over <b>200 active users</b>.
              </p>
              <p className="mb-4">
                In 2023, Rotary International recognized me as the top graduating student in
                secondary school; a recognition of my dedication, curiosity, and results.
              </p>
              <p className="mb-4">
                ...
                , and there&apos;s something about the fast pace and split-second decisions that
                keeps me coming back. Plus, debugging code after a good game always feels easier
                somehow.
              </p>
            </div>
